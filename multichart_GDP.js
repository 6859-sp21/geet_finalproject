...
d3.csv("https://raw.githubusercontent.com/6859-sp21/a4-worldbankdata/main/GDP_billions2.csv")
.then(function(data) {
...
.selectAll("*").remove()
     ...
     d3.select("#selectButton2")
      ...
      .data(allCountries)
      .join('option')
      .attr('class', 'itemsinlist')
      .text(function (d,i) { return i+1+"."+d; }) // text showed in the menu
      .attr("value", function (d) { return d; })



        entries = ["United States","China","Japan","India","Germany"];
...
d3.select("#add-btn2").on("click", function(e){
    // entries = ["India"]
    entries.push("India")
...
d3.select("#replay2").on("click", function(e){
    entries = ["India"]
    update()
});

d3.select("#topthree").on("click", function(e){
    entries = ["United States","China","Japan","India","Germany"]//,"Norway","Switzerland"] //,"Ireland","Denmark","Qatar","Singapore","Macao SAR, China"]
    update()
});
// d3.select("#lowerthree").on("click", function(e){
//     entries = ["Tuvalu","India"]
//     update()
// });
